...
digitalWrite(8, HIGH);
 ...
 pinMode(12, OUTPUT);  // pin 4 como salida para controlar pololu 4
 pinMode(13, OUTPUT);   // pin 7 como salida para controlar pololu 4
...
if(millis()- Time2>= 2000 & funcionmenu==1) //temporizador de cada ,5 segundos para antena
{
  funcionmenu = 0;
  lcd.setCursor(0, 1);      // ubica cursor en columna 12 y linea 0
  lcd.print("MEM             ");
